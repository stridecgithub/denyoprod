...
function postmsg(obj) {
	...
	if (postm) {
		console.log("Pos Obj" + pos + "Pos Arr" + JSON.stringify(pos) + "Id Obj" + id + "Id Arr" + JSON.stringify(id));
		console.log("File Attached list from storage:" + localStorage.getItem('fileAttach'));
