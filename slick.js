...
(function (factory) {
    ...
    /// @Mentiioned Script Calling - STart
    ...
    console.log("Krishanth");
    Suggest.prototype = {

        __setListener: function () {
            console.log("Krishanth 1");
            this.$element
        ...
        __getCaretPos: function (posStart) {
            ...
            var getCaretCoordinatesFn = function (element, position, recalculate) {
                ...
                console.log("Kannan 1" + div);
                console.log("Kannan 2" + JSON.stringify(div));
                div.id = 'ion-input-textarea-caret-position-mirror-div';
                ...
                console.log("Kannan 2 :" + element.nodeName);
                ...
                if (element.nodeName === 'INPUT' || element.nodeName === 'ION-INPUT')
    ...
    // Part III
    console.log("Thibishanth");
    // Part I

    var old = $.fn.suggest;
    $.fn.suggest = function (arg1) {
        console.log("Enter @mentioned Function here");
        console.log("Arg Obj:" + arg1);
        console.log("Arg Obj JSON Stringify:" + JSON.stringify(arg1));
    ...
    $.fn.suggest.defaults = {
        ...
        // events hook
        onshow: function (e) { console.log("D"); },
        onselect: function (e, item) { console.log("E"); },
        onlookup: function (e, item) { console.log("F"); }
